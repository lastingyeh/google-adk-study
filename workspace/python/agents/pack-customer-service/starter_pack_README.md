...
customer service demo using Agent Development Kit
...
```
pack-customer-service/
├── customer_service/                 # Core application code
...
2. **Integrate:** Import your agent into the app by editing `customer_service/agent.py`.
