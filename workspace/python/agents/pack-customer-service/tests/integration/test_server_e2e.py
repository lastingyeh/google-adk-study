...
def start_server() -> subprocess.Popen[str]:
    ...
    command = [
        ...
        "-m",
        "uvicorn",
        "customer_service.fast_api_app:app",
        "--host",
        "0.0.0.0",
        "--port",
        "8000",
    ...
    env["AGENT_ENGINE_SESSION_NAME"] = "test-pack-customer-service"
...
def test_chat_stream(server_fixture: subprocess.Popen[str]) -> None:
    ...
    session_url = f"{BASE_URL}/apps/customer_service/users/{user_id}/sessions"
...
def cleanup_agent_engine_sessions() -> None:
    ...
    try:
        ...
        agent_name = os.environ.get(
            "AGENT_ENGINE_SESSION_NAME", "pack-customer-service"
        )
