...
# 啟用 CICD Runner 專案的 Cloud Resource Manager API
...
# 重點摘要
# - **核心概念**：啟用 Google Cloud APIs
# - **關鍵技術**：google_project_service
# - **重要結論**：啟用 CICD 和部署專案所需的各項 API (如 Cloud Build, AI Platform 等)。
# - **行動項目**：無
