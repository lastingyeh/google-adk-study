...
# 變數定義
# ============================================================================
# 此檔案定義所有 Terraform 配置所需的輸入變數：
# - 專案識別資訊（project_name, project IDs）
# - 部署配置（region, repository）
# - IAM 角色清單（app_sa_roles, cicd_roles）
# - 功能開關（create_repository）
# - 日誌過濾器（feedback_logs_filter）
# ============================================================================
...
variable "host_connection_name" {
  ...
  type        = string
  default     = "pack-adk-a2a-agent-github-connection"
}
