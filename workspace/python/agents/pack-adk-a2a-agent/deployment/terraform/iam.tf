...
# ============================================================================
# 此檔案配置所有服務帳號的 IAM 權限：
# 1. CI/CD 專案權限：授予 CI/CD 服務帳號在其專案中的執行權限
# 2. 跨專案部署權限：授予 CI/CD 服務帳號在 staging/prod 專案的部署權限
# 3. 應用程式權限：授予應用程式服務帳號執行 AI Agent 所需的權限
# 4. Container Registry 存取：允許 Cloud Run 拉取容器映像
# 5. 特殊權限：Token 建立和服務帳號模擬權限
# ============================================================================
