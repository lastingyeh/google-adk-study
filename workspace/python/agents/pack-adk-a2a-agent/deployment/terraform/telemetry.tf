...
# 遙測與監控基礎設施
# ============================================================================
# 此檔案建立完整的遙測資料收集和分析基礎設施：
#
# 1. BigQuery 資料集和連接：用於分析遙測資料
# 2. Cloud Logging Bucket：專用的日誌儲存桶，保留 10 年
# 3. 日誌接收器 (Log Sinks)：
#    - GenAI 遙測日誌：捕獲 AI 推論操作詳細資訊
#    - 使用者回饋日誌：捕獲使用者回饋資料
# 4. 連結資料集：將 Cloud Logging 資料連結到 BigQuery
# 5. Completions 外部資料表：指向 GCS 中存放的 prompt/response 資料
# 6. Completions 視圖：結合日誌和 GCS 資料的分析視圖
# ============================================================================
