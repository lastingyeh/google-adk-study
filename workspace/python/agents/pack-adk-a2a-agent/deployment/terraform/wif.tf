...
# ============================================================================
# 此檔案配置 GitHub Actions 與 GCP 之間的無金鑰認證：
# - 建立 Workload Identity Pool 供 GitHub Actions 使用
# - 建立 OIDC Provider 連接 GitHub 的身份提供者
# - 配置屬性對應（repository, repository_owner）
# - 設定存取條件以限制特定儲存庫
# - 授予 GitHub Actions principal 模擬 CI/CD 服務帳號的權限
#
# 這消除了在 GitHub 中儲存 GCP 服務帳號金鑰的需求，提升安全性
# ============================================================================
