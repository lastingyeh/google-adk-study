...
# ============================================================================
# Google Cloud API 服務啟用
# ============================================================================
# 此檔案負責啟用所需的 Google Cloud API 服務：
# - 為 CI/CD 專案啟用必要服務（Cloud Build, Discovery Engine, AI Platform 等）
# - 為 staging 和 prod 專案啟用部署所需服務（Cloud Run, IAM, BigQuery 等）
# - 確保 Cloud Resource Manager API 可用於資源管理
# ============================================================================

# 為 CI/CD 專案啟用必要的 Google Cloud 服務
