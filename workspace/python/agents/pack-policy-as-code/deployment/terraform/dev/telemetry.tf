...
# ====================================================================
# GenAI 遙測專用 Cloud Logging Bucket (Dev 環境)
# ====================================================================
...
# 建立 BigQuery 視圖 (整合 Cloud Logging 和 GCS 資料)
