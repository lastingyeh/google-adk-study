...
from policy_as_code_agent.agent import root_agent
from google.genai import types as genai_types
...
async def main():
    ...
    await session_service.create_session(
        app_name="policy_as_code_agent", user_id="test_user", session_id="test_session"
    )
    runner = Runner(
        agent=root_agent, app_name="policy_as_code_agent", session_service=session_service
    )
