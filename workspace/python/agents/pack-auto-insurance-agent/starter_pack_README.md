...
AI agent for auto insurance using Apigee API Hub for tools
...
```
pack-auto-insurance-agent/
├── auto_insurance_agent/         # Core agent code
...
2. **Integrate:** Import your agent into the app by editing `auto_insurance_agent/agent.py`.
