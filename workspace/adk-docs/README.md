...
| [BigQuery Tools](./tools-and-integrations/integrations/bigquery.md) | 連接 BigQuery 以擷取資料並執行分析 |
| [Bigtable Tools](./tools-and-integrations/integrations/bigtable.md) | 與 Bigtable 互動以擷取資料並執行 SQL |
| [Cartesia](./tools-and-integrations/integrations/cartesia.md) | 產生語音、本地化語音並建立音訊內容 |
| [Chroma](./tools-and-integrations/integrations/chroma.md) | 使用語義向量搜尋儲存和擷取資訊 |
| [Google Cloud Trace](./tools-and-integrations/integrations/cloud-trace.md) | 監控、偵錯及追蹤 ADK agent 互動 |
| [Code Execution Tool with Agent Engine](./tools-and-integrations/integrations/code-exec-agent-engine.md) | 在安全且可擴展的 GKE 環境中執行 AI 生成的程式碼 |
| [Code Execution](./tools-and-integrations/integrations/code-execution.md) | 使用 Gemini 模型執行程式碼並進行偵錯 |
| [Computer Use](./tools-and-integrations/integrations/computer-use.md) | 使用 Gemini 模型操作電腦使用者介面 |
| [Data Agents](./tools-and-integrations/integrations/data-agent.md) | 使用 AI 驅動的 agents 進行資料分析 |
| [Daytona](./tools-and-integrations/integrations/daytona.md) | 在安全沙箱中執行程式碼、執行 Shell 指令和管理檔案 |
